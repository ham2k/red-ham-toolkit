...
module.exports = function (RED) {
        ...
        node.on('input', function (msg) {
            ...
            if (typeof payload === 'string') {
                ...
                if (typeof payload.call === 'string') {
                    ...
                    node.warn('h2k-parse-callsign: unrecognised payload shape');
                    return;
                }

            } else {
                node.warn('h2k-parse-callsign: payload must be a string or object');
                return;
            }
    ...
    RED.nodes.registerType('h2k-parse-callsign', ParseCallsignNode);
};
